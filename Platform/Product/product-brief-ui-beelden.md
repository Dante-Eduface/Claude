...
**De hoofdregel:** `Platform/Product/product.md` is de enige bron voor productclaims. Staat een functie daar niet in, dan teken je hem ook niet. Een verzonnen knop in een beeld is hetzelfde als een verzonnen claim in een mail.
...
- `Platform/Product/product.md` — de bron voor elke claim
...
- `Design/Merk/richtlijnen/brand-guidelines.md` — merk breed
