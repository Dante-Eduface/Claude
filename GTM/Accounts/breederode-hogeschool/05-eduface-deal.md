...
- **Eigenaar bij ons:** Dante, met Jeroen aan tafel

## Tijdlijn
| Datum | Wat |
|---|---|
| 13-08-2026 | Koude mail aan Irma over navolgbaarheid tussen examinatoren, plus LinkedIn-connectieverzoek |
| 21-08-2026 | Telefoontje Jeroen x Irma. Irma verzamelt binnen twee dagen 8 mensen voor een demo |
| 25-08-2026 | **Fysieke demo op locatie Rotterdam**, 11:00-12:30, 8 deelnemers. Irma sluit af met "jullie hebben me verrast" |
| 01-09-2026 | Gesprek Dante met Marloes de Graaf en Ivonne Duiser over succescriteria en testmoment |
| 03-09-2026 | Meeting met Irma, Marina en Jochem: groen licht op budget, tijdlijn en succescriteria. Lead naar Sales proces |
| 04-09-2026 | Jeroen stuurt Go Live-document. Irma stemt af met Marcel (Calder) |
| 07-09-2026 | Testochtend geprikt: **woensdag 23 september, 9:00-12:30, op locatie** |
...
- **3,5 van 5 sterren** op gebruiksvriendelijkheid en bruikbaarheid.
Jeroen noemde als thema's ook: beoordeling van de AI-feedback door studenten en docenten, het tegengaan van inconsistentie, en de ondersteuning door ons team.
...
- **Economic buyer:** Irma, met Marcel van Calder als medebeslisser op scope, looptijd en contract.
- **Decision criteria:** de twee succescriteria, plus impliciet het oordeel van het visitatiepanel (AeQui) over het gebruik van AI.
- **Decision process:** test → succescriteria toetsen → pilotcontract via Calder.
- **Paper process:** niet besproken. Contract loopt langs Marcel.
- **Identified pain:** overzicht en consistentie tussen docenten in modulair onderwijs, handmatige toewijzing van nakijkwerk in Excel, kalibratie op steekproefbasis.
- **Champions:** Marloes de Graaf en Ivonne Duiser. Aanvullend welwillend: Jochem, Sanne, Marina.
- **Competition:** geen directe concurrent. De echte concurrent is twijfel of AI hier nodig is, plus TrainTool dat al in het hbo-v curriculum zit.

## Bezwaren die op tafel lagen
1. **Inhoudelijke diepgang.** Twijfel of het model genoeg vakkennis heeft voor hun specifieke domein. Grootste bezwaar, en precies wat de testochtend moet weerleggen.
2. **Hallucineren** (Kas van Kruining). Jochem pareerde dat mensen ook hallucineren.
3. **Mens blijft eindverantwoordelijk.** Geen discussie voeren, gelijk geven, het is hoe het werkt.
4. **Tijdbesparing is niet voor iedereen het argument.** Marloes gelooft in makkelijker en veiliger, Marlies in tijdwinst. Kies je argument per persoon.
