...
_Bijgewerkt 25-09-2026 (tweede ronde). Mailadressen uit de Close-thread, functietitels uit hun eigen handtekeningen._

## Beslissers
| Naam | Rol | Mail | Positie in de deal |
|---|---|---|---|
| **Irma van der Velden** | Directeur (in NLQF-publicatie 2021: Directeur Onderwijs & Kwaliteit) | i.vandervelden@breederode.nl · 06 48132077 | **Economic buyer.** Zette de demo op, verzamelde binnen dagen 8 mensen, sloot de demo af met "jullie hebben me verrast". Eigenaar van toetsbeleid, examencommissie, NVAO, NLQF, NRTO. Zit vandaag in de financiële meeting. |
| **Marcel Lekkerkerker** | Directeur Calder Holding (moeder) | — | Hoeft niet aan tafel, maar **wil meebeslissen** over welke opleidingen in de pilot, hoe lang, welk resultaat telt als succes, en wil het contract beoordelen. |

## Opleidingsmanagers en programmaleiders
| Naam | Rol | Mail | Positie |
|---|---|---|---|
...
| **Marina Vinken-Hol** | Manager Opleidingen Huisartsenzorg (vrijdag afwezig) | m.vinken@breederode.nl | **Haar beoordelingsstijl is onbekend**: in geen van de aangeleverde bestanden staat een regel feedback van haar. Actief. Levert CAT-materiaal POH-6 aan, kan alleen 23 september. |
...
| **Kas van Kruining** | **Programmamanager Praktijkopleider in de Gezondheidszorg (POG), onderwijskundig adviseur & docent** (uit zijn eigen handtekening, 25-09) | k.vankruining@breederode.nl | **Bevestigd: hij is de K.J. van Kruining die onze ijkpunt-beoordelingen ondertekende.** Schreef dat op 25-09 zelf. **Niet langer te behandelen als tegenstander:** hij vraagt uit zichzelf of zijn eigen feedback vergelijkbaar was met die van het model, en of hij er als examinator iets van kan leren. Vroeg zelf om een gesprek op Teams. Was niet op de testdag omdat hij moest invallen voor een zieke docent, dus geen desinteresse. Mogelijk is hij de onderwijskundige uit de discovery van 25-08. |
| **Selma de Nijs, PhD** | **Klinisch epidemioloog, docent, examinator, programmamanager opleiding tot overgangsconsulent, researchverpleegkundige/researchcoordinator** (eigen handtekening, 25-09). Woensdag afwezig | s.denijs@breederode.nl | **Zij heeft de twee CAT-verslagen aangeleverd**, Kas heeft de beoordelingen ondertekend. Sloot zich op 25-09 aan bij Kas' verzoek om de resultaten door te nemen. Als klinisch epidemioloog zal zij de methodologische feedback scherp wegen. |
...
- Kwaliteitsorganen: **examencommissie**, **toetsborgingscommissie** (steekproef achteraf), **toetsexpertcommissie (TEC)** (kwaliteit vooraf, geeft feedback op álle concepttoetsen), curriculumcommissie, beroepenveldcommissie, opleidingscommissie.
- Er is een onderwijskundige die het hele team ondersteunt, maar volgens onze discovery **weinig interne macht** heeft.
