...
**Waar de drempel vandaan komt** (zie `Archive/losse-bestanden/prijsmodel-nl-opleiding-26-27.md`): 7.500 euro toolfee per opleiding plus een infrastructuurstaffel op studentplaatsen **per opleiding**, niet op het instellingstotaal.
