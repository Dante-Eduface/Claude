# Overdracht: van wireframe naar kleur

Landingspagina Eduface, demopagina voor Google Ads-verkeer. Stand 15-09-2026.
...
| 2 · proef, één onderdeel op echte kwaliteit | af voor hero (`proef-hero.html` v2), bewijsblok (`proef-bewijsblok.html` v9) en pijn (`proef-pijn.html` v1) |
...
`Platform/Product/product.md` is de enige bron voor productclaims. Staat het er niet, dan beweer je het niet.
...
Bron: `GTM/Knowledge/pijn-oplossing/docs/HANDOFF-landingspagina.md`, 50 goedgekeurde uitspraken uit Close.

Eén pijn met drie gezichten:

- **De docent voelt tijd.** Maar zegt nooit "minder werk". Zegt: "ik kom niet toe aan de feedback die ik wil geven."
- **De student ziet willekeur.** Hetzelfde werk, een 7 bij de een en een 6 bij de ander.
- **De beslisser betaalt voor risico.** Als het zichtbaar wordt voor een derde: een klacht, een NVAO-rapport, of staff die al AI gebruikt zonder goedgekeurde route.
...
| `proef-pijn.html` | ingekleurde pijnsectie, v1, poort 2 af |
...
| `creatives/product-images/` | gerenderde product-UI's, waaronder `hero.png` |
