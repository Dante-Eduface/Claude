...
Je werkt aan `Design/Website/app-homepage-redesign/proeven/home-redesign.html`, de home page voor docenten die **al** cursussen en opdrachten hebben.
...
- **Oldest waiting** is het hoofdsignaal. Eduface verkoopt snelle formatieve feedback. De pijn is bij lange trajecten uitval en bij korte de werkdruk van beoordelaars, en allebei gaan over de wachttijd, niet over de planningskalender. Zie `Platform/Product/product.md`. Een kolom die iets anders meet dan de belofte van het product, meet het verkeerde ding.
