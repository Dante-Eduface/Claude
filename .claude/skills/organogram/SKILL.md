...
Visual template to copy: `GTM/Accounts/rug-groningen/onderzoek/organogram.html`. Copy its tokens and structure, then apply the HARD RULES below (they fix mistakes made before).
