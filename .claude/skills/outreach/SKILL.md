...
- `Platform/Product/product.md`: de enige bron voor wat je over Eduface beweert.
...
**De brontoets geldt twee kanten op, ook op wat je over Eduface beweert.** Het product staat in `Platform/Product/product.md`. Staat een functie daar niet, dan noem je hem niet.
