...
2. **Discovery kennis strak hebben** — wat moet Dante uit z'n hoofd weten: het product (alleen wat echt bestaat, zie `Platform/Product/product.md`), de referentieklanten, de prijsstructuur, de antwoorden op de standaard bezwaren.
