...
Regels bij volume:
- **Leg de afvallers vast met reden en citaat**, in `projects/targetlijst-nl/dossiers.md`. Anders onderzoekt de volgende ronde ze opnieuw.
...
Twijfel je? De registers beslissen: staat de organisatie in NRTO of CRKBO, dan is het segment B. Voor segment B geldt bovendien `projects/shift/markets/nl/icp.md` als kwalificatiekader, en staat wat al onderzocht is in `projects/targetlijst-nl/dossiers.md`. **Kijk daar eerst, doe geen werk over.**
