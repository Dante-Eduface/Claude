...
## Wat er al staat
- `.claude/skills/content-voice/voice-by-type.md` heeft nog GEEN aparte sectie voor "opvolgmail na geaccepteerd LinkedIn-verzoek". De dichtstbijzijnde secties zijn "Cold outreach" en "LinkedIn connectieverzoek", maar een opvolgmail is een ander moment (warm, ze hebben al geaccepteerd) dus verdient een eigen sectie.
...
2. Volg de bestaande content-voice-flow: principe uit de instantie halen, loggen in `feedback-log.md` onder een nieuw of bestaand type, sectie bijwerken in `voice-by-type.md`.
