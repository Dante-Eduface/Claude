...
- Skills can lean on other skills. `hot-lead-outreach` defers message voice to `cro-of-eduface`. State the dependency in the body ("read that skill's logic when drafting").
