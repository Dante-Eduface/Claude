...
4. **Het antwoord eerst.** De eerste alinea beantwoordt de zoekvraag in 40 tot 60 woorden, en elke H2 opent met een zin die op zichzelf klopt. 44% van de ChatGPT-citaties komt uit het eerste derde van de pagina (Kevin Indig, 18.012 citaties, 2026), en een lezer die zijn antwoord meteen ziet, blijft.
5. **Subvragen als eigen secties.** AI Mode splitst een vraag op in deelvragen (query fan-out, bevestigd door Google). Een artikel dat de deelvragen die een koper echt heeft (kosten, integratie, compliance, accuraatheid, wie keurt goed) elk een eigen kop geeft, wordt op meer daarvan gevonden.
