...
- Reuse `projects/rug-groningen/organogram.html` as the visual template: tiers (directie → domain managers → teams), clean role-color-coded cards, optional faces, a legend, and a short CRO-assessment box.
