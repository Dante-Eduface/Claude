...
1. `Design/Merk/richtlijnen/brand-guidelines.md` — kleuren, fonts, logo-regels, toon.
2. `Design/System/core/tokens.css` — exacte design-tokens (kleur, type-schaal, radius, schaduw). **Verzin nooit losse waarden, lees ze hier.**
