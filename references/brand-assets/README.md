...
Centrale bibliotheek met Eduface merk-assets. **Eén bron** — gebruik deze, niet kopieën die in een project zijn beland.

- `logos/` — `logo_navy.png` (op licht), `logo_white.png` (op navy/donker). Niet roteren, stretchen of herkleuren.
